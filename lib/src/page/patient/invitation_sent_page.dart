...
class InvitationSentPage extends ConsumerStatefulWidget {
  const InvitationSentPage({super.key, required this.name, required this.gender});

  final String name;
  final String gender;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _InvitationSentPageState();
}

class _InvitationSentPageState extends ConsumerState<InvitationSentPage> {
  ...
  void setTherapistTitle() {
    if (widget.gender == 'male') therapistTitle = 'Dott.';
    if (widget.gender == 'female') therapistTitle = 'Dott.sa';
    debugPrint('View: InvitationSentPage setTherapistTitle is called with therapistTitle: $therapistTitle');
  }
                  ...
                  child: RichText(
                    text: TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text: ' $therapistTitle ${widget.name} ',
                          style: const TextStyle(
                            fontSize: RepathyStyle.standardTextSize,
                        ...
                        TextSpan(
                          text: AppLocalizations.of(context)!.requestSentDescriptionPartThree,
                        ),
                      ],
                    ),
                  ),
